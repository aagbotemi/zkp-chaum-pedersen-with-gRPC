...
impl ZKP {
    pub fn compute_pair(&self, exp: &BigUint) -> (BigUint, BigUint) {
        // let pair_one = Self::exponentiate(&self.alpha, exp, &self.p);
        // let pair_two = Self::exponentiate(&self.beta, exp, &self.p);

        // n^exp mod p
        let pair_one = self.alpha.modpow(exp, &self.p);
        let pair_two = self.beta.modpow(exp, &self.p);
        (pair_one, pair_two)
    }

    /// bytes -> BigUint
    pub fn deserialize(des: &[u8]) -> BigUint {
        BigUint::from_bytes_be(des)
    }

    /// BigUint -> bytes
    pub fn serialize(ser: &BigUint) -> Vec<u8> {
        ser.to_bytes_be()
    }
...
mod test {
    ...
    fn test_1024_bits_constants() {
        ...
        */
        ...
        // let beta = alpha.modpow(&BigUint::from(8454387u32), &p);
        // let alpha = BigUint::from(4u32);
        // let beta = BigUint::from(9u32);
        // let p = BigUint::from(23u32);
        // let q = BigUint::from(11u32);
    ...
    #[test]
    fn test_2048_224_bits_constants() {
        /*
                   The hexadecimal value of the prime is:
    ...
    #[test]
    fn test_2048_256_bits_constants() {
        /*
                 The hexadecimal value of the prime is:
        ...
        */
        ...
        let alpha = BigUint::from_bytes_be(
            &hex::decode("").unwrap(),
        );
        // beta = alpha^x is also a generator
        let beta = alpha.modpow(&ZKP::generate_random_number_below(&q), &p);
        // let beta = alpha.modpow(&BigUint::from(8454387u32), &p);
